...
export default function Home() {
  ...
  return (
    <div className={styles.mainCont}>
      <div className={`${styles.mainImgCont} ${styles.mainImg}`}></div>
      <div className={styles.mainContText}>
        <div className={styles.title}>SONIC TRANSMITTER RECORDS</div>
        ...
        <div className={styles.releaseCard}>
          <span>
            <h3 style={{ display: "inline" }}>No Beast That Cannot Be Slain</h3>
